...
class WordGenerator {
  ...
  static let possibleWords = ["AUDIO", "BREAK", "COUGH", "DIRTY", "EMPTY", "FLAIL", "GRARL", "HEART", "IGLOO", "JOINT", "KRILL", "LEMON", "MONEY", "NICHE", "OVARY", "POISE", "QUEEN", "RAZOR", "SAUTE", "TERSE", "UNDER", "WHERE", "ZEBRA"]
